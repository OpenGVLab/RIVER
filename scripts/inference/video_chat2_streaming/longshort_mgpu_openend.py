...
if not debug:
    ...
    sd_path = {"PATH_TO/videochat2/videochat2_hd_mistral_7b_stage4.pth":1.0}
    ...
    with open(save_json,"a") as f:
        for idx in tqdm(range(len(json_file))[ext_len:]):
            ...
            if data_anno['q_num'] % num_tasks == int(gpu_id):
                ...
                op_chat.messages.append([op_chat.roles[0], long_term_prompt.format(current_time)+f"<Video><VideoHere></Video>\n"])
                ...
                for i in range(num_batches):
                    ...
                    with torch.no_grad():
                        ...
                        video_emb, _, _ = model.encode_img(batch_video, [system]) #len=1
                ...
                print("final",short_video_emb.shape)
                short_video_emb_list.append(short_video_emb)
