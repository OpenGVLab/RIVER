...
def build_vit(config, pt_type='origin'):
    ...
    if pt_type == 'stage1_qformer':
        ckpt_path = "PATH_TO/LongVideo/pretrained_models/umt_l16_qformer-umt.pth"
        state_dict = torch.load(ckpt_path, map_location='cpu')
    elif pt_type == 'stage2_qformer_mistral':
        ckpt_path = "PATH_TO/LongVideo/pretrained_models/videochat2_mistral_7b_stage2-umt.pth"
        state_dict = torch.load(ckpt_path, map_location='cpu')
    else:
        ckpt_path = "PATH_TO/models/videochat-next/l16_25m_vision.pt"
