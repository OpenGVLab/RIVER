...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    elif "umt-qformer-mistral" in vision_tower:
        return UMTVisionTower(vision_tower, vision_tower_cfg=vision_tower_cfg, pt_type='stage2_qformer_mistral',**kwargs)
    elif "umt-qformer" in vision_tower:
        return UMTVisionTower(vision_tower, vision_tower_cfg=vision_tower_cfg, pt_type='stage1_qformer',**kwargs)
    elif "umt-hd" in vision_tower:
        return UMTVisionTower(vision_tower, vision_tower_cfg=vision_tower_cfg, image_size=336, **kwargs)
